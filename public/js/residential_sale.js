...
function saveAndContinuePropertyDetails() {
  ...
  if (apartmentType && bhkType && floorNumber && totalFloors && propertyAge && facing && builtUpArea && (floorNumber <= totalFloors)) {
    ...
    alert(
      "Please fill in all required fields in Property Details before continuing."
    );
  }
}
function saveAndContinueRentalDetails() {
  ...
  if (
    ...
    alert(
      "Please fill in all required fields in Rental Details before continuing."
    );
  }
}
...
function saveAndContinueLocalityDetails() {
  ...
  if (city && locality && landmarkStreet && description) {
    ...
    alert(
      "Please fill in all required fields in Locality Details before continuing."
    );
  }
}
...
function postProperty() {
  ...
  if (
    isFormFilled(propertyDetailsForm) &&
    isFormFilled(rentalDetailsForm) &&
    isFormFilled(localityDetailsForm) &&
    isFormFilled(galleryForm) &&
    isFormFilled(amenitiesForm)
  ) {
